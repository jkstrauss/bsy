...
app.controller('myCtrl', function($scope) {
  ...
  $scope.content = (function() {
	...
	[
      ...
      ['כֵּֽפֶל תּוֹרָה מַתְחִיל',  'עַד סוֹף קְרִיאַת שְׁמַע',  'וְאֶת טוּב הָאָֽרֶץ תַּנְחִיל',  'אִם שָׁמֺֽעַ תִּשְׁמַע'],
      ['לְצָרֵף פַּרְשִׁיּוֹת מַעֲשֵׂר',  'בִּרְאֵה וְכִי תָבוֹא',  'שֹוֹם תָּשִׂים מְיַסֵּר',  'אַף שֶׁבַּתָּֽוֶךְ מִכְתָּבוֹ'],
